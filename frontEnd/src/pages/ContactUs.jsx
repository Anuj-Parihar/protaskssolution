...
//   const API_KEY = "dGVUdlNJNVQzd0Y3dUwzTnphdGlnQ1FwRzBWeUZUWmFqSUxBSkNFUA==";
...
//               className="block"
//             >
//               <div className="flex items-start space-x-4 bg-white p-6 py-10 rounded-xl shadow-md hover:bg-gray-100 transition">
...
//                   <p>
//                     E-96, Road No-1 MIA Madri, Riico Near BMW Showroom Udaipur, Rajasthan 313001
//                   </p>
//                 </div>
//               </div>
//             </a>
